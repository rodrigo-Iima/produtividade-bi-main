...
def _sources(generated_at: str) -> list[dict[str, Any]]:
    return [
        _source(
            ...
            "SELECT * FROM vw_dashboard_entry_final; SELECT * FROM vw_dashboard_entry_tag;",
            "Soma de duração no grão de lançamento e cálculos derivados da relação lançamento-tag.",
            ["vw_dashboard_entry_final", "vw_dashboard_entry_tag"],
            generated_at,
            [
        ...
        _source(
            ...
            "SELECT * FROM vw_dashboard_entry_final;",
        ...
        _source(
            ...
            "SELECT * FROM vw_dashboard_entry_sprint;",
            "Fonte para atribuições de sprint e cruzamento tag × sprint.",
            ["vw_dashboard_entry_sprint"],
            generated_at,
        ...
        _source(
            ...
            "SELECT * FROM vw_dashboard_ticket_sprint;",
