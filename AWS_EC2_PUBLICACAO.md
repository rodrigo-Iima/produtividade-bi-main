...
cp .env.example .env
# preencher Jira, Clockify, credenciais do Login Flow e PostgreSQL
# definir FLOW_ENABLED=true depois de configurar FLOW_LOGIN_USERNAME e FLOW_LOGIN_PASSWORD
